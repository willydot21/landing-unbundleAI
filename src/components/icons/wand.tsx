...
export default function Wand({color, colorHover}: ISvgProps) {
  return (
    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" className={colorHover + (colorHover ? ' hover:cursor-pointer ' : ' ') + color} viewBox="0 0 24 24">
